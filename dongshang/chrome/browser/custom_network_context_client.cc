...
CustomNetworkContextClient::CustomNetworkContextClient() : receiver_(nullptr) {}

CustomNetworkContextClient::CustomNetworkContextClient(
    mojo::PendingReceiver<mojom::NetworkContextClient> receiver)
    : receiver_(this, std::move(receiver)) {}

CustomNetworkContextClient::~CustomNetworkContextClient() {}

void CustomNetworkContextClient::OnFileUploadRequested(
    int32_t process_id,
    bool async,
...
void CustomNetworkContextClient::OnCanSendSCTAuditingReport(
