...
#ifndef DONG_SHANG_CHROME_CUSTOM_NETWORK_CONTEXT_CLIENT_H_
#define DONG_SHANG_CHROME_CUSTOM_NETWORK_CONTEXT_CLIENT_H_
...
class CustomNetworkContextClient : public network::mojom::NetworkContextClient {
 public:
  CustomNetworkContextClient();
  explicit CustomNetworkContextClient(
      mojo::PendingReceiver<mojom::NetworkContextClient> receiver);
  ~CustomNetworkContextClient() override;
...
#endif  // DONG_SHANG_CHROME_CUSTOM_NETWORK_CONTEXT_CLIENT_H_
