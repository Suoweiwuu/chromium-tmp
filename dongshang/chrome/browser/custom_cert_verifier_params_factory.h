...
#ifndef DONG_SHANG_CHROME_BROWSER_CUSTOM_CERT_VERIFIER_PARAMS_FACTORY_H_
#define DONG_SHANG_CHROME_BROWSER_CUSTOM_CERT_VERIFIER_PARAMS_FACTORY_H_
...
class CustomCertVerifierParamsFactory
    : public cert_verifier::mojom::CertVerifierService {
 public:
  CustomCertVerifierParamsFactory();
  ~CustomCertVerifierParamsFactory() override;
...
#endif  // DONG_SHANG_CHROME_BROWSER_CUSTOM_CERT_VERIFIER_PARAMS_FACTORY_H_
