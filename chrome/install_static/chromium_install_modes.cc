...
const wchar_t kProductPathName[] = L"DongShang";
...
const InstallConstants kInstallModes[] = {
    // The primary (and only) install mode for Chromium.
    {
        ...
        L"DongShang",  // A distinct base_app_name.
        L"DongShang",  // A distinct base_app_id.
        L"DongShangHTM",                             // ProgID prefix.
        L"DongShang HTML Document",                  // ProgID description.
